...
Distance between DNA and RNA pairs along all PCoA axes ($m_{BC}^{n}$) equal pair-wise dissimilarity ($D_{BC}$). Thus, computing the pair-wise distance among a sub-selection of axes of the PCoA captures a proportion of the overall pair-wise dissimilarity that is explained by the drivers of the selected axes.

### Figure S4: Statistical support for m\textsubscript{S}:m\textsubscript{BC} interpretations
```{r, echo=FALSE,fig.show='hold',fig.align='center', out.width = "90%"}
...
### Figure S5: Classification of abundance groups
```{r, echo=FALSE,fig.show='hold',fig.align='center', out.width = "90%"}
...
### Figure S6: Taxonomic composition of habitat types
...
### Figure S7: No clear clustering within terrestrial samples
...
### Figure S8: Habitat type and seasonal separation of RNA
