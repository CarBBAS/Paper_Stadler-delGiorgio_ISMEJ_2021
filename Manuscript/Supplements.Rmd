...
### Figure S7: Environmental variables along the continuum
```{r, echo=FALSE,fig.show='hold',fig.align='center', out.width = "100%"}
knitr::include_graphics(c("../Figures/Final/abiotic_vars.png"))
``` 

Depicted are boxplots where the middle line represents the median, lower and upper hinges correspond to the 25th and 75th percentiles. Upper and lower whiskers expand to the largest and smallest value, respectively, but no further than 1.5 times the IQR from the hinge.

### Figure S8: Taxonomic composition of habitat types
...
### Figure S12: Alpha-diversity decreases along the continuum
```{r, echo=FALSE,fig.show='hold',fig.align='center', out.width = "100%"}
