...
Distance between DNA and RNA pairs along all PCoA axes ($m_{BC}^{n}$) equal pair-wise dissimilarity ($D_{BC}$). Thus, computing the pair-wise distance among the first three axes of the PCoA captures a proportion of the overall pair-wise dissimilarity that is explained by the drivers of the first three axes.

### Figure S4: Classification of abundance groups
```{r, echo=FALSE,fig.show='hold',fig.align='center', out.width = "90%"}
...
### Figure S5: Taxonomic composition of habitat types
...
### Figure S6: No clear clustering within terrestrial samples
...
### Figure S7: Habitat type and seasonal separation of RNA
